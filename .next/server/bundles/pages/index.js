...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fire__ = __webpack_require__("./pages/fire.js");
...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentWillMount() {
      ...
      var messagesRef = __WEBPACK_IMPORTED_MODULE_2__fire__["a" /* default */].database().ref('messages').orderByKey().limitToLast(100);
      messagesRef.on('child_added', function (snapshot) {
        ...
        _this2.setState({
          messages: [message].concat(_this2.state.messages)
        });
      });
    }
  }, {
    ...
    value: function addMessage(e) {
      ...
      __WEBPACK_IMPORTED_MODULE_2__fire__["a" /* default */].database().ref('messages').push(this.inputEl.value);
