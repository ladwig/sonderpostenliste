...
function (_Component) {
  ...
  _createClass(AddProduct, [{
    ...
    value: function handleSubmit(e) {
      if (this.state.product != "" || this.state.productid != "" || this.state.price != "") {
        e.preventDefault();
        var itemsRef = __WEBPACK_IMPORTED_MODULE_2__components_firebase__["a" /* default */].database().ref('items');
        var item = {
      ...
      } else return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "errorMsg",
        __source: {
...
//# sourceMappingURL=5.baa97dfe61ae5bb3da40.hot-update.js.map